...
- `knowledge_bases(id integer generated by default as identity, name, description, is_deleted, created_at, updated_at)`
- `sessions(id integer generated by default as identity, title, chat_mode, knowledge_base_id integer, is_deleted, created_at, updated_at)`
- `messages(id integer generated by default as identity, session_id integer, role, content, used_rag, sources, created_at)`
- `documents(id integer generated by default as identity, knowledge_base_id integer, filename, content_type, file_path, file_size, status, error, chunk_count, created_at, updated_at)`
